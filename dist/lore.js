...
Lore.Renderer = function () {
    ...
    _createClass(Renderer, [{
        ...
        value: function init() {
            ...
            // Blending
            if (this.opts.enableTransparency) {} else if (this.opts.enableDepthTest) {
